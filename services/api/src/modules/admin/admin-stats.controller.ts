...
export class AdminStatsController {
  ...
  @ApiOkResponse({
    description: 'Statistiques incidents',
    type: AdminIncidentsStatsDto,
  })
  @ApiForbiddenResponse({ description: 'Action réservée aux administrateurs' })
